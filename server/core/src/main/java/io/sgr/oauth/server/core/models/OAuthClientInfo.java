...
public class OAuthClientInfo implements Serializable {
    ...
    public OAuthClientInfo(final String id, final String secret, final String name, final String description, final String iconUrl, final String privacyUrl,
            final String owner, final long createdTimeMs) {
