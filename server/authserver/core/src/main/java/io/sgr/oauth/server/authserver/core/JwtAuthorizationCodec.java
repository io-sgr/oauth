...
public class JwtAuthorizationCodec implements AuthorizationCodec<AuthorizationDetail> {
    ...
    @Override
    public String encode(final AuthorizationDetail authDetail) throws JwtException {
    ...
    @Override
    public AuthorizationDetail decode(final String authCode) throws JwtException {
