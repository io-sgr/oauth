...
public class OAuthErrorTypeTest {
	...
	public void testToJson() throws JsonProcessingException {
		...
		assertEquals("[\"invalid_request\",\"invalid_scope\",\"unauthorized_client\",\"invalid_client\",\"unsupported_response_type\",\"invalid_grant\",\"unsupported_grant_type\",\"access_denied\",\"server_error\",\"temporarily_unavailable\"]", json);
	}

	@Test
	public void testFromJson() throws IOException {
		final String json = "[\"invalid_request\",\"invalid_scope\",\"unauthorized_client\",\"invalid_client\",\"unsupported_response_type\",\"invalid_grant\",\"unsupported_grant_type\",\"access_denied\",\"server_error\",\"temporarily_unavailable\"]";
