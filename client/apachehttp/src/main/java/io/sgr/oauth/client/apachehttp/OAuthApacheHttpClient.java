...
public class OAuthApacheHttpClient implements OAuthHttpClient {
        ...
        switch (style) {
            case QUERY_STRING:
                try {
                    ...
                    throw new UnrecoverableOAuthException(
                            new OAuthError("invalid_token_uri", String.format("Invalid token URI: %s", this.clientConfig.tokenUri)));
                }
                break;
            default:
                try {
    ...
    public JsonNode getRawResource(OAuthCredential credential, String endpoint, String... params)
            throws UnrecoverableOAuthException, RecoverableOAuthException {
